#
#  Be sure to run `pod spec lint Conekta.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Omar Hernandez"
  # s.authors            = { "Omar Hernandez" => "happones@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/happones"
